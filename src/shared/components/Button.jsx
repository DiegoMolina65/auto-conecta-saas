...
export function Button({
  ...
  const variants = {
    ...
    outline: "border-2 border-primary text-primary bg-white hover:bg-primary hover:text-white focus:ring-gray-300",
    ghost: "text-primary bg-white hover:bg-gray-100 focus:ring-gray-300",
